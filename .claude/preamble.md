...
3. **Deterministic Tokenization**: All PII must be tokenized using HMAC-SHA256 to ensure that the same input always produces the same token within a deployment.
