...
| **dashboard-scenario-generator** | Demo Orchestrator for the Ocultar Dashboard. Provisions the Mock-API with synthetic "Attack & Defense" scenarios. |
...
| **tier_compliance_checker** | Cross-references the active detection tiers with the Sombra gateway policy. Ensures all features are enabled and correctly configured. |
| **ui-regression-orchestrator** | Runs headless browser tests to verify the "Zero-Egress" visual boundaries and UI integrity of the Ocultar Dashboard. |
