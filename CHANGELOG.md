...
### Fixed
- **Docs sidebar dead link**: removed the "Secret Management" entry in the docs sidebar, which pointed to `content/SECRETS.md` — a page that was never created and always 404'd.
